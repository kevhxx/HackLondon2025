...
patient_info = pl.read_csv(
    "/Users/tingzhanghuang/Documents/self-effort/STAY/backend/src/utils/data/patient_info_processed.csv",
    ignore_errors=True,
...
model = XGBClassifier(
    ...
    n_estimators=100,
    random_state=6
    # Matches the random_state in train_test_split <button class="citation-flag" data-index="2"><button class="citation-flag" data-index="5">
)
...
# Load model
model = joblib.load(
    "xgboost_model.pkl")  # <button class="citation-flag" data-index="5"><button class="citation-flag" data-index="6">

# Predict on new data (convert to Pandas first)
data = {"SEX": "1", "AGE": "1", "ACC": "1", "ACC_DAYS": "3", "HRV": "1", "HRV_HOURS": "10", "CPT_II": "2", "ADD": "1",
        "BIPOLAR": "1", "UNIPOLAR": "9", "ANXIETY": "10", "SUBSTANCE": "9", "OTHER": "0", "CT": "9", "MDQ_POS": "0",
        "WURS": "98", "ASRS": "5", "MADRS": "10000", "HADS_A": "10", "HADS_D": "10", "MED": "1", "MED_Antidepr": "1",
        "MED_Moodstab": "1", "MED_Antipsych": "1", "MED_Anxiety_Benzo": "1", "MED_Sleep": "1",
        "MED_Analgesics_Opioids": "1", "MED_Stimulants": "1"}
...
for i in x:
    y = i[0]
    z = i[1]
    print(f"Possibility of non-ADHD: {y:.1%}")
    print(f"Possibility of ADHD: {z:.1%}")
